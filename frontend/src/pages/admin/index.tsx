...
import {
  ...
  FaSpinner, FaBoxOpen, FaTags, FaFileExcel, FaEye, FaExclamationTriangle, FaChartLine,
} from 'react-icons/fa';
        ...
        <header className="bg-white border-b border-slate-200 sticky top-0 z-30">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <Link
                href="/admin/metricas"
                className="flex items-center gap-2 text-sm font-medium text-slate-600 hover:text-teal-700 px-3 py-2 rounded-lg hover:bg-slate-100 transition-colors"
              >
